export default function D4BreakerDiagram({ stage = 3 }: { stage?: number }) {
  ...
  return (
    <svg viewBox="0 0 1040 300" role="img" aria-label="熔断器状态机：关闭态连续失败达到阈值进入打开态，冷却后半开探测，成功恢复" className="diagram diagram-sm">
      <title>D4 分布式弹性 · 熔断器状态机</title>
      <defs>
