...
export const domains: Domain[] = [
  {
    ...
    concepts: ["统一响应模型", "错误码体系", "版本化", "幂等键", "分页", "Schema 前向 / 后向兼容", "入参声明式校验", "OpenAPI", "通信范式选择", "消息投递语义", "契约测试", "HTTP 缓存语义", "海勒姆定律（Hyrum's Law）"],
    invariants: [
  ...
  },
  {
    ...
    concepts: ["模块边界", "依赖规则（单向 · 无环）", "规范自动化（lint · 门禁）", "测试金字塔", "CI/CD", "ADR 架构决策记录", "功能开关与灰度发布", "环境一致性", "代码评审（Code Review）", "代码所有权（CODEOWNERS）", "第三方依赖管理", "技术债管理", "弃用与下线流程", "康威定律与团队边界", "值班与升级路径", "文档与 Runbook", "棘轮机制（只进不退）", "绞杀者模式（Strangler Fig）", "黄金路径（Paved Road）"],
    invariants: [
